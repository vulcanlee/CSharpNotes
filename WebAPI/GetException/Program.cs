...
namespace GetException
{
    class Program
    {
        ...
        {
            var foo = await GetExceptionFilter();
        ...
        private static async Task<APIResult> GetExceptionFilter()
        {
            ...
            using (HttpClientHandler handler = new HttpClientHandler())
            {
                using (HttpClient client = new HttpClient(handler))
                {
                    ...
                    {
                        #region 呼叫遠端 Web API
                        string FooUrl = $"http://vulcanwebapi.azurewebsites.net/api/values/GetExceptionFilter";
